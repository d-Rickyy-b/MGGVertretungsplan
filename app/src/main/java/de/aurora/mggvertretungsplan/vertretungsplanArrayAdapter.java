...
public class vertretungsplanArrayAdapter extends ArrayAdapter<Vertretungen>{
	...
	public View getView(int position, View view, ViewGroup viewGroup) {
		...
		if (view == null) {
			...
			//Stunde
			viewHolder.StundeView = (TextView) updateView
					.findViewById(R.id.stunde);
			//From
			viewHolder.RaumView = (TextView) updateView
					.findViewById(R.id.raum);
			// ETA
			viewHolder.FachView = (TextView) updateView
					.findViewById(R.id.fach);
			// Type			
			viewHolder.NeuRaumView = (TextView) updateView
					.findViewById(R.id.neuraum);
			//Speed
			viewHolder.BemerkungView = (TextView) updateView
					.findViewById(R.id.bemerkung);
			//Alt
			viewHolder.DatumView = (TextView) updateView
					.findViewById(R.id.datum);	
			//Alt
			viewHolder.TagView = (TextView) updateView
